...
Config::Config(std::string fName, DeviceList** dl, UpnpClient_Handle _cph)
{
    fileName = fName;
    ...
    UpnpMaxContentLength = xmlGetChildElementValue( rootElement, "UpnpMaxContentLength");
    //....
...
bool Config::CreateFile(std::string fName, DeviceList* dl)
{
    ...
    ixmlNode_appendChild( &root->n, setVal("UpnpMaxContentLength",  UpnpMaxContentLength, doc));
